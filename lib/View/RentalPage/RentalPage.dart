...
class RentalPage extends StatefulWidget {
  ...
  RentalPage({Key? key,required this.objMyPropertiesDetails}) : super(key: key);
...
class _RentalPageState extends State<RentalPage> {
  ...
  void initState() {
    ...
    super.initState();
    cnt_Myproperties.txtNotes.value!.text='';
    cnt_Myproperties.txtPropertyArea.value!.text='';
    cnt_Myproperties.txtExpectedRent.value!.text='';
  }
  @override
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      key: cnt_Myproperties.GlobalRentalPagekey,
      ...
      body: SafeArea(
        child: Stack(
          children: [
            ...
            cnt_HeaderController.commonAppBar("Rental",
                cnt_Myproperties.GlobalRentalPagekey),
            // Align(
  ...
  Widget RentalFormData(){
    return Container(
      ...
      child: Form(
        key: cnt_Myproperties.RentalFormkey,
        child: Column(
          children: [
            simpleTextFieldNewWithCustomization(
              ...
              controller: cnt_Myproperties.txtPropertyArea,
              labelText: "Property Area (in Sq.Ft.)",
              // validator: (value) =>
              //     validation(value, "Please enter property area")
            ),
            SizedBox(height: 20),
            simpleTextFieldNewWithCustomization(
              hintText: "",
              ...
              inputFormat: [FilteringTextInputFormatter.allow(RegExp("[0-9a-zA-Z ]")),
                UpperCaseTextFormatter()],
              controller: cnt_Myproperties.txtExpectedRent,
              labelText: "Expected Rent (per Month)",
              // validator: (value) =>
              //     validation(value, "Please enter property area")
            ),
            SizedBox(height: 20),
            QueryTextField_2(cnt_Myproperties.txtNotes),
