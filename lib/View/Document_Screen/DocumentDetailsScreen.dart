...
class DocumentDetailsScreen extends StatefulWidget {
  String doc_id;
  DocumentDetailsScreen({required this.doc_id});
  @override
  DocumentDetailsScreenState createState() => new DocumentDetailsScreenState();
}

class DocumentDetailsScreenState extends State<DocumentDetailsScreen> with TickerProviderStateMixin {
  ...
  void initState() {
    super.initState();
    cnt_document.dcocument_id?.value=widget.doc_id;
              ...
              child: Stack(children: [
                ...
                Positioned(
                  ...
                  child: cnt_CommonHeader.commonAppBar(
                      "Documents", GlobalDocumentScreenkey,
